...
if(isset($_POST['btn_action']))
{
	...
	if($_POST['btn_action'] == 'Add')
	{
		$query = "
		INSERT INTO product
		 (category_id, brand_id, seller_id, product_name, batch_no, hsn, expiry_date, product_description, product_quantity, product_unit, product_base_price, discount, sgst, cgst, product_enter_by, product_status, product_date) 
		VALUES
	   (:category_id, :brand_id, :seller_id, :product_name, :batch_no, :hsn, :expiry_date, :product_description, :product_quantity, :product_unit, :product_base_price, :discount, :sgst, :cgst, :product_enter_by, :product_status, :product_date)
		";
